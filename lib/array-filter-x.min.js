 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),assertIsFunction=_dereq_("assert-is-function-x"),some=_dereq_("array-some-x");module.exports=function filter(array,callBack){var object=toObject(array);assertIsFunction(callBack);var result=[],args=[object,function _wrapped(item,idx,obj){callBack.call(this,item,idx,obj)&&(result[result.length]=item)}];return arguments.length>2&&(args[2]=arguments[2]),some.apply(void 0,args),result}},{"array-some-x":2,"assert-is-function-x":3,"to-object-x":30}],2:[function(_dereq_,module,exports){/**
